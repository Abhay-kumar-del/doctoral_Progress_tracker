...
import { Upload, FileText, User, Settings } from 'lucide-react';
    ...
    <div className="flex min-h-screen bg-[#f8fafc]">
      ...
      <main className="flex-1 transition-all">
        <header className="py-4 px-8 bg-white border-b border-gray-100 flex justify-between items-center">
          <h1 className="text-2xl font-medium text-gray-900">Publications</h1>
        ...
        <div className="p-8">
          <div className="grid grid-cols-1 gap-6">
            <InfoCard title="Research Publications" className="mb-6">
              <div 
              ...
              >
                ...
                <p className="text-blue-600 font-medium mb-1">
                  {file ? file.name : "Click to upload Research Publication"}
                </p>
            ...
            <InfoCard title="Existing Publications">
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 border border-gray-100 rounded-lg bg-white hover:shadow-sm transition-all">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">Machine Learning Advances</p>
                      <p className="text-sm text-gray-500">2025-02-15</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 border border-gray-100 rounded-lg bg-white hover:shadow-sm transition-all">
                  <div className="flex items-center gap-3">
                    <FileText className="w-6 h-6 text-blue-600" />
                    <div>
                      <p className="font-medium text-gray-900">AI Ethics Research</p>
                      <p className="text-sm text-gray-500">2025-03-01</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 border border-gray-100 rounded-lg bg-white hover:shadow-sm transition-all">
                  <div className="flex items-center gap-3">
                    <FileText className="w-6 h-6 text-blue-600" />
                    <div>
                      <p className="font-medium text-gray-900">Neural Network Optimization</p>
