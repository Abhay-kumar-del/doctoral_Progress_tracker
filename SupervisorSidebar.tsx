...
const SupervisorSidebar: React.FC<SupervisorSidebarProps> = ({ userName, className }) => {
  ...
  const navItems = [
    ...
    { icon: FileCheck, label: 'DC Meetings', path: '/supervisor/dc-meetings' },
    { icon: FileText, label: 'Publications', path: '/supervisor/publications' },
    { icon: CalendarClock, label: 'Exam Requests', path: '/supervisor/exams' },
  ];
    ...
    <>
      ...
      <aside className={cn("bg-white border-r border-gray-100 w-[220px] flex flex-col transition-all", className)}>
        <div className="p-6 border-b border-gray-100 flex flex-col items-center">
          <h2 className="text-xl font-semibold text-blue-600">Supervisor Portal</h2>
